package com.example.gd8_d_0824
...
import com.example.gd8_d_0824.adapters.MahasiswaAdapter
import com.example.gd8_d_0824.api.MahasiswaApi
import com.example.gd8_d_0824.models.Mahasiswa
...
class MainActivity : AppCompatActivity() {
    ...
    private fun allMahasiswa(){
        ...
        val stringRequest: StringRequest =
            object: StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                val gson = Gson()
                ...
                if(!mahasiswa.isEmpty())
                    Toast.makeText(this@MainActivity, "Data berhasil diambil All Mahasiswa", Toast.LENGTH_SHORT).show()
                else
    ...
    fun deleteMahasiswa(id: Long){
        setLoading(true)
        val stringRequest: StringRequest =
            object: StringRequest(Method.DELETE, MahasiswaApi.DELETE_URL + id , Response.Listener { response ->
                setLoading(false)
